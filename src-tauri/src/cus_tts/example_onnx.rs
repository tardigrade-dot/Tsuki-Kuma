...
struct Args {
    ...
    #[arg(long, default_value = "supertonic/onnx")]
    onnx_dir: String,
    ...
    #[arg(long, value_delimiter = ',', default_values_t = vec!["supertonic/voice_styles/M1.json".to_string()])]
...
pub fn default_tts_inference(text: &str) -> Result<(Vec<f32>, i32)> {
    ...
    let model_path: &PathBuf = TTS_MODEL_BASE_PATH.get()
...
mod tests {
    ...
    fn test_run_tts_simple() -> Result<()> {
        ...
        let test_config = TtsConfig {
            use_gpu: true,
            onnx_dir: "/Users/larry/github.com/Tsuki-Kuma/src-tauri/ai_models/supertonic/onnx", // 使用 mock 或最小化模型路径
            total_step: 15,
            n_test: 1,
            voice_style_paths: &[
                "/Users/larry/github.com/Tsuki-Kuma/src-tauri/ai_models/supertonic/voice_styles/F1.json".to_string(),
                "/Users/larry/github.com/Tsuki-Kuma/src-tauri/ai_models/supertonic/voice_styles/M1.json".to_string(),
            ],
            text_list: &[
